...
(function () {
  ...
  css.textContent = [
    ...
    '.crew-bob,.crew-clink,.crew-steam,.crew-wake{transform-box:fill-box;transform-origin:center}',
    ...
    '@keyframes crewClink{0%,41%{opacity:0;transform:scale(.4)}45%{opacity:1;transform:scale(1.18)}49%{transform:scale(.94)}53%{transform:scale(1.06)}62%{opacity:1;transform:scale(1)}67%,100%{opacity:0;transform:scale(.4)}}',
    '.crew-clink{opacity:0;animation:crewClink 9s ease-in-out infinite}',
    ...
    '@media(prefers-reduced-motion:reduce){.crew-ship,.crew-bob,.crew-steam,.crew-wake,.crew-foam,.crew-hop{animation:none}.crew-ship{transform:translate(172px,63px)}.crew-clink{opacity:1;animation:none}.crew-smile{opacity:1;animation:none}.crew-mouth{opacity:0;animation:none}}',
